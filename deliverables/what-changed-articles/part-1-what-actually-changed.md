...
This paper argues that the comprehension gap is the main reason enterprises get stuck. It examines what changed, why the change is hard to absorb, and what it looks like when individuals and organizations genuinely "get it". This group is exploring governance frameworks, operating models, and operational standards designed to close the comprehension gap.

---

## What actually changed

For most of AI's commercial history, systems were narrow and task-specific. A system that recommended products had no capacity to process a customer complaint. A fraud detection model had no ability to query a database or draft a response. Narrow systems are powerful within their domains, but they operate in isolation and require explicit human orchestration at every transition.
...
They respond to questions, but can also pursue goals across multi-step sequences and adapt their approach based on intermediate results.
