...
The orange arrow returns audit evidence to policy. The figure still carries the earlier,
longer names for each document; the names in the table below replace them.*
