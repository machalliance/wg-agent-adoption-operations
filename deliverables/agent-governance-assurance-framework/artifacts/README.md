...
| 5 | 3. Platform controls | [Platform and Sign-off Record](03-platform-controls/platform-and-sign-off-record.md), then get it signed | Record |
...
| 8 | 5. Audit and assurance | [Audit Log Rules](05-audit-and-assurance/audit-log-rules.md) — what agents add to the records policy you already have, settled once | Standard |
